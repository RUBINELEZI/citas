        ...
        <ul class="navbar-nav mr-auto">
            <?php if (isset($_SESSION['user_id'])) : ?>
                <li class="nav-item active">
                    <a class="nav-link" href="<?php echo URL ?>Posts"">Home<span class="sr-only">(current)</span></a>
                </li>
                <li class="nav-item">
            ...
            <?php else: ?>
            <li class="nav-item active">
                <a class="nav-link" href="<?php echo URL ?>users/index"">Home<span class="sr-only">(current)</span></a>
            </li>
            <li class="nav-item">
                <a class="nav-link" href="#">Forums</a>
            </li>
